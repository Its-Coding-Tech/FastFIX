...
<div class="hero_area">
        ...
        <div class="row">
          <div class="col-md-6 ">
            <div class="detail-box">
              <h1>
                Welcome to FastFIX<br>
                Repair and <br>
                Maintenance <br>
                Services
              </h1>
              <p>
               FastFIX – Your One-Stop Solution for Quick and Reliable Home Services! Whether you need a repair, maintenance, or a helping hand around the house, our team of skilled professionals is here to ensure your home runs smoothly. Experience convenience and quality service at the click of a button with FastFIX!
              </p>
      ...
      <div class="row">
        <div class="col-lg-5 col-md-6">
          <div class="detail-box">
            ...
            <p>
            At FastFIX, we understand that your home is your sanctuary, and keeping it in perfect condition is essential for your peace of mind. Founded with a commitment to providing fast, reliable, and high-quality home services, FastFIX is your go-to platform for all your household needs.
            </p>
            <a href="">
              Read More
            </a>
      ...
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="detail-box">
            ...
            <p>
            Our mission is to simplify home maintenance and repair by connecting you with skilled professionals who can handle everything from minor fixes to major renovations. We aim to make home care effortless, allowing you to enjoy your space without the stress of ongoing upkeep.
            </p>
            <a href="">
              Read More
            </a>
  ...
  <section id="services">
  <div class="services_section layout_padding-bottom">
        ...
        <div class="services-container">
            ...
            <div class="service-section">
             <img src="images/s2.png" alt="" />
                <article>
                    <h2 class="service-heading"> Electrican </h2>
                    <p>
                    Our certified electricians are ready to handle all your electrical needs, from simple repairs to complex installations.
                    Whether it's fixing a faulty switch, installing new lighting, or rewiring your home, we've got you covered.
                    </p>
                </article>
            </div>
            ...
            <div class="service-section">
             <img src="images/s3.png" alt="" />
                <article>
                    <h2 class="service-heading"> Plumber </h2>
                    <p>Dealing with leaks, clogs, or other plumbing issues? Our experienced plumbers provide fast and effective solutions for all your plumbing needs, including pipe repairs, fixture installations, and routine maintenance.</p>
                </article>
            </div>
            <!-- Service Item Ends here -->
            ...
            <img src="images/s5.png" alt="" />
                <article>
                    <h2 class="service-heading"> AC repairing </h2>
                    <p>Keep your home cool and comfortable with our expert AC repair services. Our technicians are skilled in diagnosing and fixing a wide range of air conditioning issues to ensure your system runs efficiently all year round.</p>
                </article>
            </div>
            <div class="detail-box">
            <a href="services.php">
...
if($conn->connect_error) {
 die("connection failed");
                ...
                $sql = "SELECT reviewer_name, service_name, rating, review FROM reviews";
                ...
                if ($result === FALSE) {
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            $reviewer_name = htmlspecialchars($row['reviewer_name']);
