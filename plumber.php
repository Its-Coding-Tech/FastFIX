...
<div class="hero_area">
  <header class="header_section">
    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        <div class="card">
          <img src="images/plumber.jpg" class="card-img-top service-image" alt="Electrical Tools">
          <div class="card-body">
            <h4 class="card-title">Plumber Services</h4>
            <p class="card-text">
            FastFIX provide plumbing services. Our plumbers are skilled, trained, and professional, capable of handling any type of plumbing work needed for your home, office, or other properties.
            </p>
            <p class="card-text">
            We offer both maintenance and repair services, such as diagnosing and resolving plumbing issues, as well as services for new construction projects, including the installation of piping, water tanks, faucets, drainage systems, and more.
            </p>
            <p class="card-text">
