...
<div class="hero_area">
  <header class="header_section">
    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        <div class="card">
          <img src="images/Ac-repair.jpg" class="card-img-top service-image" alt="Electrical Tools">
          <div class="card-body">
            <h4 class="card-title">Ac Reparing</h4>
            <p class="card-text">
            FastFIX provides AC repair services. Our technicians, with their expertise and attention to detail, quickly address any air conditioning issues—whether in your home, office, or other spaces. 
            </p>
            <p class="card-text">
            We offer both maintenance and repair services, including diagnosing and fixing cooling problems, compressor issues, gas leaks, thermostat malfunctions, and more. We handle all major AC brands and models, including split, window, and central air conditioning systems.
            </p>
            <p class="card-text">
