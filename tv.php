...
<head>
  ...
  <title>Tv Reparing Services</title>
...
<div class="hero_area">
  <header class="header_section">
    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        <div class="card">
          <img src="images/tv.jpg" class="card-img-top service-image" alt="Electrical Tools">
          <div class="card-body">
            <h4 class="card-title">Tv Reparing Services</h4>
            <p class="card-text">
            FastFIX provide TV repair services. Our technicians, with steady hands and sharp eyes, move swiftly through any TV issue—whether it’s in your living room, office, or elsewhere.
            </p>
            <p class="card-text">
            We offer both maintenance and repair services, including diagnosing and fixing display issues, sound problems, power failures, and more. We handle all major brands and types of TVs, including LED, LCD, OLED, and plasma models.
            </p>
            <p class="card-text">
