...
<div class="hero_area">
  <header class="header_section">
    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        <div class="card">
          <img src="images/pc.jpg" class="card-img-top service-image" alt="Electrical Tools">
          <div class="card-body">
            <h4 class="card-title">PC Reparing Services</h4>
            <p class="card-text">
            FastFIX provides PC repair services. Our technicians, with their expert knowledge and precision, swiftly resolve any computer issues—whether for your home, office, or other workspaces. 
            </p>
            <p class="card-text">
            We offer both maintenance and repair services, including diagnosing and fixing hardware failures, software issues, performance slowdowns, and more. We handle all types of PCs, including desktops, laptops, and custom-built systems, across all major brands.
            </p>
            <p class="card-text">
