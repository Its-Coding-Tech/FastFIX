...
<div class="hero_area">
  <header class="header_section">
    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        <div class="card">
          <img src="images/carpenter.jpg" class="card-img-top service-image" alt="Electrical Tools">
          <div class="card-body">
            <h4 class="card-title">Carpenter Services</h4>
            <p class="card-text">
            FastFIX provides carpenter services. Our skilled and experienced carpenters work efficiently to address all your carpentry needs—whether it's for your home, office, or any other property. 
            </p>
            <p class="card-text">
            We offer both maintenance and new project services, including furniture repairs, custom-built cabinetry, woodwork installations, doors, windows, and more. From small repairs to large construction projects, we handle it all with precision and care. 
            </p>
            <p class="card-text">
